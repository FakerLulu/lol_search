...
<body>
    ...
    <script src="./js/detail/initDetail.js"></script>
    <script src="./js/detail/imageSetting.js"></script>
    <script src="./js/detail.js"></script>
    
<script type="template" id="slideImage">
                                    <li class="item" style="width: 414px;"> <img alt="" class="img_thumb" src="./img/{{fileName}}"> <span class="img_bg"></span>
                                        <div class="visual_txt">
                                            <div class="visual_txt_inn">
                                                <h2 class="visual_txt_tit"> <span></span> </h2>
                                                <p class="visual_txt_dsc"></p>
...
<script type="template" id="commentHasImg">
                                <li class="list_item">
                                    <div>
                                        ...
                                        <div class="info_area">
                                            <div class="review_info"> <span class="grade">{{score}}</span> <span class="name">{{email}}</span> <span class="date">{{create_date}} 방문</span> </div>
                                        </div>
                                    </div>
                                </li>
</script>
<script type="template" id="commentNoImg">
                                <li class="list_item">
                                    <div>
